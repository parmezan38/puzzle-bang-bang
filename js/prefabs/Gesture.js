...
define(['phaser'], function(Phaser) {
  ...
  Gesture.prototype.update = function() {
    let distance = Phaser.Point.distance(this.game.input.activePointer.position, this.game.input.activePointer.positionDown),
        duration = this.game.input.activePointer.duration;
